...
CREATE DEFINER=`root`@`localhost` PROCEDURE `abaptran_data_param_parsekvu`(
...
--       call debug_msg('Update 1');
         update abapanalytics.abaptran set key1 = v_kvu_key, value1 = v_kvu_value where tcode = i_kvu_tcode;
        when 2 then
--       call debug_msg('Update 2');
         update abapanalytics.abaptran set key2 = v_kvu_key, value2 = v_kvu_value where tcode = i_kvu_tcode;
        when 3 then
--       call debug_msg('Update 3');
         update abapanalytics.abaptran set key3 = v_kvu_key, value3 = v_kvu_value where tcode = i_kvu_tcode;
        when 4 then
--       call debug_msg('Update 4');
         update abapanalytics.abaptran set key4 = v_kvu_key, value4 = v_kvu_value where tcode = i_kvu_tcode;
        when 5 then
--       call debug_msg('Update 5');
         update abapanalytics.abaptran set key5 = v_kvu_key, value5 = v_kvu_value where tcode = i_kvu_tcode;
        when 6 then
--       call debug_msg('Update 6');
         update abapanalytics.abaptran set key6 = v_kvu_key, value6 = v_kvu_value where tcode = i_kvu_tcode;
        when 7 then
--       call debug_msg('Update 7');
         update abapanalytics.abaptran set key7 = v_kvu_key, value7 = v_kvu_value where tcode = i_kvu_tcode;
        else
