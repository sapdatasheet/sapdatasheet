            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    ...
                    <div class="page-header">
                        <h3>SAP TCode Analytics by Name</h3>
                    </div>
                    <div>
                    ...
                    <div class="panel panel-info">
                        ...
                        <br />
                        <table id="chartdata_main" class="table table-hover table-condensed">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr><td><?php echo GLOBAL_ABAP_ICON::getIcon4NamePrefix(TRUE) ?>
