		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<div class="pb-2 mt-3 mb-2 border-bottom">
					<h4>SAP TCode Analytics by Component</h4>
				</div>
									...
									<td>
										<div class="row">
											<div class="col-xs-4 col-sm-4 col-md-4">
                                                    ...
                                                    <a
													href="<?php echo $comp_item[SITE_UI_CONST::KEY_URL] ?>"
													target="_blank"
													title="<?php echo $comp_item[SITE_UI_CONST::KEY_CAPTION] ?>"><?php echo $comp_item[SITE_UI_CONST::KEY_LABEL] ?></a>
