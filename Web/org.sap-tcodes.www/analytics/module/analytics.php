...
<meta name="keywords"
	content="SAP,ABAP,TCode,Transaction Code,<?php echo $appl_posid ?>,<?php echo $appl_desc ?>">
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-sm-9">
                ...
                <?php $title_bc_list = SITE_UI_ANALYTICS::AnaModuleBreadcrumbs ( $appl_posid ); require $__ROOT__ . '/include/site/site_ui_breadcrumb.php'; ?>

                <!-- Page Header -->
				<div class="pb-2 mt-3 mb-2 border-bottom">
					<h4><?php echo $title ?><?php echo ABAP_UI_DS_Navigation::GetObjectHyperlink4DS(GLOBAL_ABAP_OTYPE::BMFR_NAME, $abapbmfr['FCTR_ID']) ?></h4>
				</div>
							...
							<tbody>
									...
									<td><div class="row">
											<div class="col-xs-4 col-sm-4 col-md-4">
													...
													target="_blank"
													title="<?php echo $module_item[SITE_UI_CONST::KEY_CAPTION] ?>">
