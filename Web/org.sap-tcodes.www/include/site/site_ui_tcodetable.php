...
<?php if ($tcode_count > ABAPANA_DB_TABLE::MAX_ROWS_LIMIT) { ?>
    <div class="panel-footer">
        <strong><?php echo number_format(ABAPANA_DB_TABLE::MAX_ROWS_LIMIT) ?></strong> of <strong><?php echo number_format($tcode_count) ?></strong> tcodes loaded.
