			...
			<div class="col-sm-12">
				...
				<ul class="nav nav-tabs">
					<li class="nav-item"><a class="nav-link active" data-toggle="tab"
						href="#dlsheet-module"><?php echo GLOBAL_ABAP_ICON::getIcon4OtypeBMFR(TRUE) ?> Sheets by Module</a></li>
					<li class="nav-item"><a class="nav-link" data-toggle="tab"
						href="#dlsheet-component"><?php echo GLOBAL_ABAP_ICON::getIcon4OtypeCVERS(TRUE) ?> Sheets by Component</a></li>
					<li class="nav-item"><a class="nav-link" data-toggle="tab"
						href="#dlsheet-name"><?php echo GLOBAL_ABAP_ICON::getIcon4NamePrefix(TRUE) ?> Sheets by Name</a></li>
