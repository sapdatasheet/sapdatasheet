        ...
        <div class="left">
            ...
            <table class="content_obj">
                <tbody>
                    ...
                    <tr><td class="left_value"><?php echo GLOBAL_ABAP_ICON::getIcon4OtypeCLAS() ?>
                    ...
                    <table class="alv">
                        ...
                        foreach ($metarel as $metarel_item) {
                            ...
                            <tr><td class="alv" style="text-align: right;"><?php echo number_format($count) ?> </td>
                                <td class="alv"><?php echo ABAP_UI_DS_Navigation::GetHyperlink4DomainValue(ABAP_DB_TABLE_SEO::SEOMETAREL_RELTYPE_DOMAIN, $reltype_desc, $metarel_item['RELTYPE']) ?>&nbsp;</td>
                                <td class="alv"><?php echo ABAP_UI_DS_Navigation::GetObjectHyperlink(GLOBAL_ABAP_OTYPE::SEOC_NAME, $metarel_item['REFCLSNAME']) ?></td>
                ...
                <table class="content_obj">
                    <tbody>
                        <tr><td class="content_label"> Class </td>
                            <td class="field"> <?php echo ABAP_UI_DS_Navigation::GetHyperlink4Clas($ObjID, $class_tx, FALSE); ?> </td>
                            <td> &nbsp;</td>
                        </tr>
                        ...
                        <tr><td class="content_label"> Super Class </td>
                            <td class="field"> <?php echo ABAP_UI_DS_Navigation::GetHyperlink4Clas($class_super, $class_super_tx); ?> </td>
                        ...
                        <tr><td class="content_label"> Instantiability of a Class</td>
                            <td class="field"><?php echo ABAP_UI_DS_Navigation::GetHyperlink4DomainValue(ABAP_DB_TABLE_SEO::SEOCLASSDF_EXPOSURE_DOMAIN, $classdef['EXPOSURE'], $exposure_tx); ?>&nbsp;</td>
                ...
                <table class="content_obj">
                    <tbody>
                        ...
                        <tr><td class="content_label"> Program status</td>
                            <td class="field"> <?php echo ABAP_UI_DS_Navigation::GetHyperlink4DomainValue(ABAP_DB_TABLE_SEO::SEOCLASSDF_RSTAT_DOMAIN, $classdef['RSTAT'], $rstat_tx); ?>&nbsp;</td>
                            <td> <?php echo $rstat_tx ?>&nbsp; </td>
                        </tr>
                        <tr><td class="content_label"> Category </td>
                            <td class="field"> <?php echo ABAP_UI_DS_Navigation::GetHyperlink4DomainValue(ABAP_DB_TABLE_SEO::SEOCLASSDF_CATEGORY_DOMAIN, $classdef['CATEGORY'], $category_tx); ?>&nbsp;</td>
                ...
                <?php if (empty($typepls) === FALSE) { ?>
                    <table class="alv">
                        ...
                        foreach ($typepls as $typepl) {
                            ...
                            ?>
                            <tr><td class="alv" style="text-align: right;"><?php echo number_format($count) ?> </td>
                                <td class="alv"><?php echo GLOBAL_ABAP_ICON::getIcon4Abaplocal() ?>
                ...
                <?php if (empty($attributes) === FALSE) { ?>
                    <table class="alv">
                        ...
                        foreach ($attributes as $attribute) {
                            ...
                            ?>
                            <tr><td class="alv" style="text-align: right;"><?php echo number_format($count) ?> </td>
                                <td class="alv"><?php echo GLOBAL_ABAP_ICON::getIcon4OOClassAttribute() ?>
