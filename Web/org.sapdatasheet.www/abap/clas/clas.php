                ...
                <main class="col-xl-8 col-lg-8 col-md-6  col-sm-9    col-12 bd-content" role="main">
                    <nav class="pt-3" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="/abap/clas/"><?php echo GLOBAL_ABAP_OTYPE::CLAS_DESC ?></a></li>
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body table-responsive sapds-card-body">
                            ...
                            <?php if (empty($metarel) === FALSE) { ?>
                                <h5 class="pt-4"> Meta Relationship - Using </h5>
                            ...
                            <?php if (empty($metarel_refs) === FALSE) { ?>
                                <h5 class="pt-4"> Meta Relationship - Used By </h5>
                                <table class="table table-sm">
                                    <tr>
                                        <th class="sapds-alv"> # </th>
                                        <th class="sapds-alv"> Relationship type </th>
                            ...
                            <?php if (isset($metarel_exceeded) && $metarel_exceeded === TRUE) { ?>
                                <h5 class="pt-4"> Meta Relationship - Using (full list) </h5>
