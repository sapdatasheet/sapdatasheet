                ...
                <main class="col-xl-8 col-lg-8 col-md-6  col-sm-9    col-12 bd-content" role="main">
                    <nav class="pt-2" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="/abap/bmfr/"><?php echo GLOBAL_ABAP_OTYPE::BMFR_DESC ?></a></li>
                        </ol>
                    </nav>
                        ...
                        <div class="card-body table-responsive sapds-card-body">
                            ...
                            <table class="table table-sm">
                                <tr>
                                    ...
                                    <th class="sapds-alv"> First Release Date </th>
                                    <th class="sapds-alv"> First Release </th>
                                ...
                                <tr>
                                    ...
                                    <th class="sapds-alv"><?php echo ABAP_UI_DS_Navigation::GetHyperlink4DtelDocument(ABAP_DB_TABLE_HIER::DF14L_PS_POSID_DTEL) ?></th>
                                    <th class="sapds-alv"> &nbsp; </th>
                                    <th class="sapds-alv"><?php echo ABAP_UI_DS_Navigation::GetHyperlink4DtelDocument(ABAP_DB_TABLE_HIER::DF14L_FSTDATE_DTEL) ?></th>
                                    <th class="sapds-alv"> &nbsp; </th>
                                ...
                                foreach ($bmfr as $row) {
                                    ...
                                    <tr><td class="sapds-alv text-right"><?php echo number_format($count) ?> </td>
                                        <td class="sapds-alv"><?php echo GLOBAL_ABAP_ICON::getIcon4OtypeBMFR() ?>
                                            <?php echo ABAP_UI_DS_Navigation::GetHyperlink4Bmfr($row['FCTR_ID'], $row['PS_POSID'], $bmfr_desc); ?> </td>
                                        <td class="sapds-alv"><?php echo htmlentities($bmfr_desc) ?></td>
                                        <td class="sapds-alv"><?php echo $row['FSTDATE'] ?></td>
                                        <td class="sapds-alv"><?php echo $row['RELE'] ?></td>
                                        <td class="sapds-alv"><?php echo $row['FCTR_ID'] ?></td></tr>
                                <?php } ?>
                            </table>
