                ...
                <main class="col-xl-8 col-lg-8 col-md-6  col-sm-9    col-12 bd-content" role="main">
                    <nav class="pt-3" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="/abap/view/"><?php echo GLOBAL_ABAP_OTYPE::VIEW_DESC ?></a></li>
                            <li class="breadcrumb-item active"><a href="#"><?php echo $dd25l['VIEWNAME'] ?></a></li>
                        </ol>
                    </nav>
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body table-responsive sapds-card-body">
                            ...
                            <h5 class="pt-4"><?php echo GLOBAL_ABAP_ICON::getIcon4OtypeTABL() ?> Table</h5>
                            <table class="table table-sm">
                                <thead>
                            ...
                            <h5 class="pt-4"><?php echo GLOBAL_ABAP_ICON::getIcon4Connect() ?> Join Conditions</h5>
                            <table class="table table-sm">
                                <thead>
                                    <tr><th class="sapds-alv">#</th>
                                        <th class="sapds-alv">Table Name</th>
                            ...
                            <!-- View Fields -->
                            <h5 class="pt-4"><?php echo GLOBAL_ABAP_ICON::getIcon4Field() ?> View Fields </h5>
                            <table class="table table-sm">
                                <thead>
                                    <tr>
                            ...
                            <!-- Maintenance Status -->
                            <h5 class="pt-4"><?php echo GLOBAL_ABAP_ICON::getIcon4MaintenanceStatus() ?> Maintenance Status </h5>
                            <table>
