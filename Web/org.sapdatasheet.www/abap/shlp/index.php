                ...
                <main class="col-xl-8 col-lg-8 col-md-6  col-sm-9    col-12 bd-content" role="main">
                    <nav class="pt-3" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="/abap/shlp/"><?php echo GLOBAL_ABAP_OTYPE::SHLP_DESC ?></a></li>
                        </ol>
                    </nav>
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body table-responsive sapds-card-body">
                            ...
                            <h5 class="pt-2"> <?php echo GLOBAL_ABAP_OTYPE::SHLP_DESC ?> - <?php echo $index ?> </h5>
                            <table class="table table-sm">
                                <tr>
                                    <th class="sapds-alv"> # </th>
                                    <th class="sapds-alv"> Search Help Name </th>
                                ...
                                <tr>
                                    ...
                                    <th class="sapds-alv"><?php echo ABAP_UI_DS_Navigation::GetHyperlink4DtelDocument(ABAP_DB_TABLE_SHLP::DD30L_SHLPNAME_DTEL) ?></th>
                                    <th class="sapds-alv"><?php echo ABAP_UI_DS_Navigation::GetHyperlink4DtelDocument(ABAP_DB_TABLE_SHLP::DD30T_DDTEXT_DTEL) ?></th>
                                ...
                                foreach ($shlp_list as $dd30l) {
                                    ...
                                    <tr><td class="sapds-alv text-right"><?php echo number_format($count) ?> </td>
                                        <td class="sapds-alv"><?php echo GLOBAL_ABAP_ICON::getIcon4OtypeSHLP() ?>
                                            <?php echo ABAP_UI_DS_Navigation::GetHyperlink4Shlp($dd30l['SHLPNAME'], $dd30t) ?></td>
                                        <td class="sapds-alv"><?php echo $dd30t ?></td>
