<?php if (isset($hier) && strlen(trim($hier->DLVUNIT)) > 0) { ?>
    ...
    <div class="hier">
        ...
        <?php if (strlen(trim($hier->DLVUNIT)) > 0) { ?>
            <span>&#9755;</span>
            <?php echo ABAP_UI_Navigation::GetURL4Cvers($hier->DLVUNIT, $hier->DLVUNIT_T) ?>
        ...
        <?php if (strlen(trim($hier->POSID)) > 0) { ?>
            ...
            <span>&#10551;</span> 
            <?php echo ABAP_UI_Navigation::GetURL4Bmfr($hier->FCTR_ID, $hier->POSID, $hier->POSID_T) ?>
        ...
        <?php if (strlen(trim($hier->PARENTCL2 )) > 0) { ?>
            <?php GLOBAL_UTIL::EchoSpace($hier_spaces) ?>
            <span>&#10551;</span>
            <?php echo ABAP_UI_Navigation::GetURL4Devc($hier->PARENTCL2, $hier->PARENTCL2_T) ?>
        ...
        <?php if (strlen(trim($hier->PARENTCL1 )) > 0) { ?>
            <?php GLOBAL_UTIL::EchoSpace($hier_spaces) ?>
            <span>&#10551;</span>
            <?php echo ABAP_UI_Navigation::GetURL4Devc($hier->PARENTCL1, $hier->PARENTCL1_T) ?>
        ...
        <?php if (strlen(trim($hier->DEVCLASS)) > 0) { ?>
            <?php GLOBAL_UTIL::EchoSpace($hier_spaces) ?>
            <span>&#10551;</span>
            <?php echo ABAP_UI_Navigation::GetURL4Devc($hier->DEVCLASS, $hier->DEVCLASS_T) ?>
