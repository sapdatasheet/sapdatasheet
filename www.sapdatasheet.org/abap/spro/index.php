...
<?php
$GLOBALS['TITLE_TEXT'] = "SAP ABAP " . ABAP_OTYPE::SPRO_DESC . " - Index " . $index . " ";
?>
<html>
    <head>
        ...
        <meta name="keywords" content="SAP,ABAP,<?php echo ABAP_OTYPE::SPRO_DESC ?>" />
    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="content_navi">
                ...
                <a href="/abap/spro/"><?php echo ABAP_OTYPE::SPRO_DESC ?></a>
            </div>
            ...
            <div class="content_obj">
                ...
                <h4> <?php echo ABAP_OTYPE::SPRO_DESC ?> - <?php echo $index ?></h4>
                <?php if ($index === ABAP_DB_CONST::INDEX_LIST) { ?>
                    <table class="alv">
                        ...
                        <?php
                        $img_list = ABAP_DB_TABLE_SPRO::CUS_IMGACH_List();
                        foreach ($img_list as $img) {
                            $img_desc = ABAP_DB_TABLE_SPRO::CUS_IMGACT($img['ACTIVITY']);
                            ?>
