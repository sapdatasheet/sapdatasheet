            ...
            <div class="content_obj">        
                ...
                <table class="alv">
                    ...
                    <tr>
                        ...
                        <th class="alv"><?php echo ABAP_Navigation::GetURLDtelDocument(ABAP_DB_TABLE_DOMA::DD01L_LENG_DTEL, '?') ?></th>
                        <th class="alv"><?php echo ABAP_Navigation::GetURLDtelDocument(ABAP_DB_TABLE_DOMA::DD01L_DECIMALS_DTEL, '?') ?></th>
                    </tr>
                    <?php
                    $count = 0;
