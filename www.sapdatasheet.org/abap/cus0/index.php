                ...
                <?php } else { ?>
                    <table class="alv">
                        ...
                        <tr>
                            ...
                            <th class="alv"> &nbsp; </th>
                            <th class="alv"> <?php echo ABAP_UI_Navigation::GetHyperlink4DtelDocument(ABAP_DB_TABLE_CUS0::CUS_IMGACH_TCODE_DTEL, '?') ?></th>
                            <th class="alv"> &nbsp; </th>
                        </tr>
                        <?php
                        ...
                        foreach ($img_list as $img) {
                            ...
                            <tr><td class="alv" style="text-align: right;"><?php echo number_format($count) ?> </td>
                                <td class="alv"><?php echo ABAP_UI_Navigation::GetHyperlink4Cus0IMGActivity($img['ACTIVITY'], $img_desc, TRUE) ?> </td>
                                <td class="alv"><?php echo ABAP_UI_Navigation::GetHyperlink4Tran($img['TCODE'], '', TRUE) ?> </td>
