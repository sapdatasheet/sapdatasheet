                ...
                <table class="content_obj">
                    <tbody>
                        <tr><td class="content_label"> ID </td>
                            <td class="field"> <?php echo ABAP_UI_Navigation::GetHyperlink4Cus0IMGActivity($imgach['ACTIVITY'], $imgach_t, FALSE); ?> </td>
                            <td> <?php echo htmlentities($imgach_t) ?> &nbsp;</td>
                        </tr>
                        <tr><td class="content_label"> Transaction Code </td>
                            <td class="field"> <?php echo ABAP_UI_Navigation::GetHyperlink4Tran($imgach['TCODE'], null) ?> &nbsp;</td>
                    ...
                    <table class="alv">
                        ...
                        foreach ($tfm18_list as $tfm18) {
                            ...
                            <tr><td class="alv"><?php echo $tfm18['DOKCLASS'] ?> </td>
                                ...
                                <td class="alv"><?php echo ABAP_UI_Navigation::GetHyperlink4Bmfr($tfm18['FUNCT'], $tfm18['FUNCT'], $tfm18_desc); ?> </td>
                       ...
                       <!-- <th class="alv"> Current Settings </th> -->
                        ...
                        <?php foreach ($actobj_list as $actobj) { ?>
                            <tr><td class="alv"><?php echo $actobj['OBJECTNAME'] ?> </td>
                                ...
                                <td class="alv"><?php echo ABAP_UI_Navigation::GetHyperlink4Tran($actobj['TCODE'], null) ?> </td>
