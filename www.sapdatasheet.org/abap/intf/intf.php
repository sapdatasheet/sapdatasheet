...
$wul_counter_list = ABAPANA_DB_TABLE::COUNTER_List(ABAP_OTYPE::INTF_NAME, $classdef['CLSNAME']);
    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="content_obj">
                ...
                <h4> Interface Tree </h4>

                <h4> Properties </h4>
                <table class="content_obj">
                    <tbody>
                        <tr><td class="content_label"> Interface </td>
                            <td class="field"> <?php echo ABAP_Navigation::GetURLInterface($ObjID, $class_tx, FALSE); ?> </td>
                            <td> &nbsp;</td>
                        </tr>
