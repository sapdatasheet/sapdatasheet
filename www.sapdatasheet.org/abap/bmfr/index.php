            ...
            <div class="content_obj">
                ...
                <table class="alv">
                    ...
                    <tr>
                        ...
                        <th class="alv"><?php echo ABAP_UI_Navigation::GetHyperlink4DtelDocument(ABAP_DB_TABLE_HIER::DF14L_PS_POSID_DTEL, '?') ?></th>
                        <th class="alv"> &nbsp; </th>
                        <th class="alv"><?php echo ABAP_UI_Navigation::GetHyperlink4DtelDocument(ABAP_DB_TABLE_HIER::DF14L_FSTDATE_DTEL, '?') ?></th>
                        <th class="alv"> &nbsp; </th>
                    ...
                    foreach ($bmfr as $row){
                        ...
                        <tr><td class="alv" style="text-align: right;"><?php echo number_format($count) ?> </td>
                            <td class="alv"><?php echo ABAP_UI_Navigation::GetHyperlink4Bmfr($row['FCTR_ID'], $row['PS_POSID'], $bmfr_desc); ?> </td>
