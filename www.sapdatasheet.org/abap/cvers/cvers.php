        ...
        <div class="left">
            ...
            <table class="content_obj">
                <tbody>
                    ...
                    <tr><td class="left_value"><?php echo ABAP_UI_Navigation::GetHyperlink4Cvers($cvers['COMPONENT'], $cvers_desc) ?>&nbsp;</td></tr>
                </tbody>
            </table>
                    ...
                    foreach ($child_bmfr as $child_bmfr_item) {
                        ...
                        foreach ($child_bmfr_item_s as $l1_bmfr) {
                            if ($l1_bmfr['LEVEL'] <= 2) {
                                ...
                                ?>
                                <tr><td class="left_value"><?php echo ABAP_UI_Navigation::GetHyperlink4Bmfr($l1_bmfr['FCTR_ID'], $l1_bmfr['PS_POSID'], $l1_bmfr_desc) ?> </td></tr>
                                <?php
                            }
                        }
                    }
                ...
                <table class="content_obj">
                    <tbody>
                        ...
                        <tr><td class="content_label"> Component type     </td>
                            <td class="field"><?php echo ABAP_UI_Navigation::GetHyperlink4DomainValue(ABAP_DB_CONST::DOMAIN_TADIR_COMP_TYPE, $cvers['COMP_TYPE'], $cvers_comp_type_desc) ?>&nbsp;</td>
                    ...
                    <table class="alv">
                        ...
                        foreach ($child_bmfr as $child_bmfr_item) {
                            ...
                            foreach ($child_bmfr_item_s as $appcomp_item) {
                                ...
                                ?>
                                <tr><td class="alv"><?php echo ABAP_UI_Navigation::GetHyperlink4Bmfr($appcomp_item['FCTR_ID'], $appcomp_item['PS_POSID'], $appcomp_desc) ?></td>
