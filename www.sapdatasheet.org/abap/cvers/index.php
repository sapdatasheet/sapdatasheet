            ...
            <div class="content_obj">
                ...
                <table class="alv">
                    ...
                    <tr>
                        ...
                        <th class="alv"><?php echo ABAP_UI_Navigation::GetURL4DtelDocument(ABAP_DB_TABLE_HIER::CVERS_COMP_TYPE_DTEL, '?') ?></th>
                        <th class="alv"><?php echo ABAP_UI_Navigation::GetURL4DtelDocument(ABAP_DB_TABLE_DOMA::DD07T_DDTEXT_DTEL, '?') ?></th>
                    </tr>
                    <?php
                    ...
                    foreach ($table as $row) {
                        ...
                        <tr><td class="alv" style="text-align: right;"><?php echo number_format($count) ?> </td>
                            <td class="alv"><?php echo ABAP_UI_Navigation::GetURL4Cvers($cvers_component, $cvers_desc) ?></td>
                            <td class="alv"><?php echo htmlentities($cvers_desc) ?></td>
                            <td class="alv"><?php echo ABAP_UI_Navigation::GetURL4DomainValue(ABAP_DB_CONST::DOMAIN_TADIR_COMP_TYPE, $cvers_comp_type, $cvers_comp_type_desc) ?></td>
