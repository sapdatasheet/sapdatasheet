        ...
        <div class="left">
            ...
            <table class="content_obj">
                <tbody>
                    ...
                    <tr><td class="left_value"><a href="/abap/clas/"><?php echo GLOBAL_ABAP_OTYPE::CLAS_DESC ?></a></td></tr>
                    ...
                    <table class="alv">
                        ...
                        foreach ($metarel as $metarel_item) {
                            ...
                            <tr><td class="alv" style="text-align: right;"><?php echo number_format($count) ?> </td>
                                <td class="alv"><?php echo ABAP_UI_Navigation::GetHyperlink4DomainValue(ABAP_DB_TABLE_SEO::SEOMETAREL_RELTYPE_DOMAIN, $reltype_desc, $metarel_item['RELTYPE']) ?>&nbsp;</td>
                                <td class="alv"><?php echo ABAP_UI_Navigation::GetObjectHyperlink(GLOBAL_ABAP_OTYPE::SEOC_NAME, $metarel_item['REFCLSNAME']) ?></td>
                ...
                <?php if (empty($metarel_refs) === FALSE) { ?>
                    ...
                    <table class="alv">
                        ...
                        foreach ($metarel_refs as $metarel_ref) {
                            ...
                            ?>
                            <tr><td class="alv" style="text-align: right;"><?php echo number_format($count) ?> </td>
                                <td class="alv"><?php echo ABAP_UI_Navigation::GetHyperlink4DomainValue(ABAP_DB_TABLE_SEO::SEOMETAREL_RELTYPE_DOMAIN, $reltype_desc, $metarel_ref['RELTYPE']) ?>&nbsp;</td>
                                <td class="alv"><?php echo ABAP_UI_Navigation::GetObjectHyperlink(GLOBAL_ABAP_OTYPE::SEOC_NAME, $metarel_ref['CLSNAME']) ?></td>
                                <td class="alv"><?php echo $metarel_cls_desc ?></td>
                ...
                <table class="content_obj">
                    <tbody>
                        <tr><td class="content_label"> Class </td>
                            <td class="field"> <?php echo ABAP_UI_Navigation::GetHyperlink4Clas($ObjID, $class_tx, FALSE); ?> </td>
                            <td> &nbsp;</td>
                        </tr>
                        ...
                        <tr><td class="content_label"> Super Class </td>
                            <td class="field"> <?php echo ABAP_UI_Navigation::GetHyperlink4Clas($class_super, $class_super_tx); ?> </td>
                        ...
                        <tr><td class="content_label"> Instantiability of a Class</td>
                            <td class="field"><?php echo ABAP_UI_Navigation::GetHyperlink4DomainValue(ABAP_DB_TABLE_SEO::SEOCLASSDF_EXPOSURE_DOMAIN, $classdef['EXPOSURE'], $exposure_tx); ?>&nbsp;</td>
                ...
                <table class="content_obj">
                    <tbody>
                        ...
                        <tr><td class="content_label"> Program status</td>
                            <td class="field"> <?php echo ABAP_UI_Navigation::GetHyperlink4DomainValue(ABAP_DB_TABLE_SEO::SEOCLASSDF_RSTAT_DOMAIN, $classdef['RSTAT'], $rstat_tx); ?>&nbsp;</td>
                            <td> <?php echo $rstat_tx ?>&nbsp; </td>
                        </tr>
                        <tr><td class="content_label"> Category </td>
                            <td class="field"> <?php echo ABAP_UI_Navigation::GetHyperlink4DomainValue(ABAP_DB_TABLE_SEO::SEOCLASSDF_CATEGORY_DOMAIN, $classdef['CATEGORY'], $category_tx); ?>&nbsp;</td>
                            <td> <?php echo $category_tx ?>&nbsp; </td>
                        </tr>
                        <tr><td class="content_label"> Package</td>
                            <td class="field"> <?php echo ABAP_UI_Navigation::GetHyperlink4Devc($hier->DEVCLASS, $hier->DEVCLASS_T) ?> &nbsp;</td>
                    ...
                    <table class="alv">
                        ...
                        foreach ($typepls as $typepl) {
                            ...
                            if ($typepl['TPUTYPE'] == ABAP_DB_TABLE_SEO::SEOTYPEPLS_TPUTYPE_1 || $typepl['TPUTYPE'] == ABAP_DB_TABLE_SEO::SEOTYPEPLS_TPUTYPE_2) {
                                $typepl_type = ABAP_UI_Navigation::GetHyperlink4Clas($typepl['TYPEGROUP'], NULL);
                            } else {
                            ...
                            <tr><td class="alv" style="text-align: right;"><?php echo number_format($count) ?> </td>
                                ...
                                <td class="alv"><?php echo ABAP_UI_Navigation::GetHyperlink4DomainValue(ABAP_DB_TABLE_SEO::SEOTYPEPLS_TPUTYPE_DOMAIN, $typepl_type_desc, $typepl['TPUTYPE']) ?>&nbsp;</td>
                ...
                <?php if (empty($interfaces) === FALSE) { ?>
                    <table class="alv">
                        ...
                        foreach ($interfaces as $interface) {
                            ...
                            ?>
                            <tr><td class="alv" style="text-align: right;"><?php echo number_format($count) ?> </td>
                                <td class="alv"><?php echo ABAP_UI_Navigation::GetHyperlink4Intf($interface['REFCLSNAME'], $interface_tx) ?></td>
                ...
                <?php if (empty($friends) === FALSE) { ?>
                    <table class="alv">
                        ...
                        foreach ($friends as $friend) {
                            ...
                            ?>
                            <tr><td class="alv" style="text-align: right;"><?php echo number_format($count) ?> </td>
                                <td class="alv"><?php echo ABAP_UI_Navigation::GetHyperlink4Clas($friend['REFCLSNAME'], $friend_tx) ?></td>
                    ...
                    <table class="alv">
                        ...
                        foreach ($attributes as $attribute) {
                            ...
                            <tr><td class="alv" style="text-align: right;"><?php echo number_format($count) ?> </td>
                                ...
                                <td class="alv"><?php echo ABAP_UI_Navigation::GetHyperlink4DomainValue(ABAP_DB_TABLE_SEO::SEOCOMPODF_ATTDECLTYP_DOMAIN, $attribute_level_tx, $seocomp_df['ATTDECLTYP']) ?></td>
                                <td class="alv"><?php echo ABAP_UI_Navigation::GetHyperlink4DomainValue(ABAP_DB_TABLE_SEO::SEOCOMPODF_EXPOSURE_DOMAIN, $seocomp_visibility_tx, $seocomp_df['EXPOSURE']) ?></td>
                                <td class="alv"><?php echo ABAP_UI_TOOL::GetCheckBox('ATTRDONLY', $seocomp_df['ATTRDONLY']) ?></td>
                                <td class="alv"><?php echo ABAP_UI_Navigation::GetHyperlink4DomainValue(ABAP_DB_TABLE_SEO::SEOCOMPODF_TYPTYPE_DOMAIN, $seocomp_typing_tx, $seocomp_df['TYPTYPE']) ?></td>
                                <td class="alv"><?php
                                    if ($seocomp_df['TYPTYPE'] == ABAP_DB_TABLE_SEO::SEOCOMPODF_TYPTYPE_3) {
                                        ...
                                        if ($clstype['CLSTYPE'] == ABAP_DB_TABLE_SEO::SEOCLASS_CLSTYPE_CLAS) {
                                            echo ABAP_UI_Navigation::GetHyperlink4Clas($seocomp_df['TYPE'], NULL);
                                        } else {
                                            echo ABAP_UI_Navigation::GetHyperlink4Intf($seocomp_df['TYPE'], NULL);
                                        }
                                    } else {
                    ...
                    <table class="alv">
                        ...
                        foreach ($methods as $method) {
                            ...
                            <tr><td class="alv" style="text-align: right;"><?php echo number_format($count) ?> </td>
                                ...
                                <td class="alv"><?php echo ABAP_UI_Navigation::GetHyperlink4DomainValue(ABAP_DB_TABLE_SEO::SEOCOMPODF_MTDDECLTYP_DOMAIN, $method_level_tx, $seocomp_df['MTDDECLTYP']) ?></td>
                                <td class="alv"><?php echo ABAP_UI_Navigation::GetHyperlink4DomainValue(ABAP_DB_TABLE_SEO::SEOCOMPODF_EXPOSURE_DOMAIN, $seocomp_visibility_tx, $seocomp_df['EXPOSURE']) ?></td>
                                <td class="alv"><?php echo ABAP_UI_Navigation::GetHyperlink4DomainValue(ABAP_DB_TABLE_SEO::SEOCOMPO_MTDTYPE_DOMAIN, $method_type_tx, $method['MTDTYPE']) ?></td>
                                <td class="alv"><?php echo $seocomp_tx ?></td>
                                <td class="alv"><?php echo $seocomp_df['CREATEDON'] ?></td>
                            </tr>
                        <?php } ?>
                        ...
                        foreach ($events as $event) {
                            ...
                            <tr><td class="alv" style="text-align: right;"><?php echo number_format($count) ?> </td>
                                ...
                                <td class="alv"><?php echo $event_type_tx ?>
                                    <br/>(<?php echo ABAP_UI_Navigation::GetHyperlink4DomainValue(ABAP_DB_TABLE_SEO::SEOCOMPODF_EVTDECLTYP_DOMAIN, $seocomp_df['EVTDECLTYP'], $method_level_tx) ?>)
                                </td>
                                <td class="alv"><?php echo $seocomp_visibility_tx ?>
                                    <br/>(<?php echo ABAP_UI_Navigation::GetHyperlink4DomainValue(ABAP_DB_TABLE_SEO::SEOCOMPODF_EXPOSURE_DOMAIN, $seocomp_df['EXPOSURE'], $seocomp_visibility_tx) ?>)
                                </td>
                                <td class="alv"><?php echo $seocomp_tx ?></td>
                                <td class="alv"><?php echo $seocomp_df['CREATEDON'] ?></td>
                            </tr>
                            ...
                            <table class="alv">
                                ...
                                foreach ($method_paras as $method_para) {
                                    ...
                                    <tr><td class="alv" style="text-align: right;"><?php echo number_format($count) ?> </td>
                                        ...
                                        <td class="alv"><?php echo ABAP_UI_Navigation::GetHyperlink4DomainValue(ABAP_DB_TABLE_SEO::SEOSUBCODF_PARDECLTYP_DOMAIN, $subco_decltype_tx, $subco_df['PARDECLTYP']) ?></td>
                                        <td class="alv"><?php echo ABAP_UI_Navigation::GetHyperlink4DomainValue(ABAP_DB_TABLE_SEO::SEOSUBCODF_PARPASSTYP_DOMAIN, $subco_passvalue_tx, $subco_df['PARPASSTYP']) ?></td>
                                        <td class="alv"><?php echo ABAP_UI_TOOL::GetCheckBox('PAROPTIONL', $subco_df['PAROPTIONL']) ?></td>
                                        <td class="alv"><?php echo ABAP_UI_Navigation::GetHyperlink4DomainValue(ABAP_DB_TABLE_SEO::SEOSUBCODF_TYPTYPE_DOMAIN, $subco_typing_tx, $subco_df['TYPTYPE']) ?></td>
                        ...
                        <?php if (empty($method_excps) === FALSE) { ?>
                            <table class="alv">
                                ...
                                foreach ($method_excps as $method_para) {
                                    ...
                                    ?>
                                    <tr><td class="alv" style="text-align: right;"><?php echo number_format($count) ?> </td>
                                        <td class="alv"><?php echo ABAP_UI_Navigation::GetHyperlink4Clas($method_para['SCONAME'], $subco_tx) ?></td>
