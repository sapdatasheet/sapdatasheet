...
<!-- ABAP OO Class index. -->
<?php
$page_label = "Page " . $index . " of " . ABAP_DBDATA::SEOCLASS_CLAS_INDEX_MAX;
$GLOBALS['TITLE_TEXT'] = "SAP ABAP " . GLOBAL_ABAP_OTYPE::CLAS_DESC . " - Index " . $page_label;
    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="content_obj">        
                ...
                <div>
                    <?php for ($count = 1; $count <= ABAP_DBDATA::SEOCLASS_CLAS_INDEX_MAX; $count++) { ?>
                        <a href="index-<?php echo $count ?>.html"><?php echo $count ?></a>&nbsp;
                    <?php } ?>
                </div>

                <h4> <?php echo GLOBAL_ABAP_OTYPE::CLAS_DESC ?> - <?php echo $page_label ?></h4>
                <table class="alv">
                    <tr>
                        <th class="alv"> # </th>
                    ...
                    <tr>
                        ...
                        <th class="alv"><?php echo ABAP_UI_Navigation::GetHyperlink4DtelDocument(ABAP_DB_TABLE_SEO::SEOCLASS_CLSNAME_DTEL, '?') ?></th>
                        <th class="alv"><?php echo ABAP_UI_Navigation::GetHyperlink4DtelDocument(ABAP_DB_TABLE_SEO::SEOCLASSTX_DESCRIPT_DTEL, '?') ?></th>
                    ...
                    foreach ($clas_list as $clas) {
                        ...
                        <tr><td class="alv" style="text-align: right;"><?php echo number_format($count) ?> </td>
                            <td class="alv"><?php echo ABAP_UI_Navigation::GetHyperlink4Clas($clas['CLSNAME'], $clas_tx) ?></td>
