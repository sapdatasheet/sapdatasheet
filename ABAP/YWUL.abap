...
PARAMETERS p_otype  TYPE tadir-object. " EUOBJ-TYPE
PARAMETERS p_count  TYPE i DEFAULT 5.
PARAMETERS p_batch  TYPE i DEFAULT 20000.
...
* Process
  ...
  LOOP AT it_list INTO lv_item.
    ...
    IF lv_counter >= p_batch.
      PERFORM submit_job USING lt_rsparam lv_start.
      CLEAR lt_rsparam.
    ENDIF.
  ENDLOOP.
...
* Wait until there is not Much Jobs
  lv_active_cnt = p_count + 1.      " Make sure come to WHILE loop
  WHILE lv_active_cnt >= p_count.
